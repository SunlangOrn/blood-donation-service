...
public class JwtConfig {
    ...
    public RSAKey rsaKeyRefreshToken(@Qualifier("keyPairRefreshToken") KeyPair keyPair) throws NoSuchAlgorithmException {
        return new RSAKey
                .Builder((RSAPublicKey) keyPair.getPublic())
                .privateKey(keyPair.getPrivate())
                .keyID(UUID.randomUUID().toString())
    ...
    public JwtDecoder jwtDecoderRefreshToken(@Qualifier("rsaKeyRefreshToken") RSAKey rsaKey) throws JOSEException {
        return NimbusJwtDecoder.withPublicKey(rsaKey.toRSAPublicKey()).build();
    }
